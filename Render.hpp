...
namespace Render
{
	...
	void HeadShootLine(const CEntity& LocalEntity, ImColor Color)
	{
		...
		// left
		Gui.RectangleFilled(Vec2{ Pos.x - 23, Pos.y - 1 }, Vec2{ 17, 3}, Color & IM_COL32_A_MASK);
		Gui.RectangleFilled(Vec2{ Pos.x - 22, Pos.y }, Vec2{ 17, 3 }, Color);

		// right
		Gui.RectangleFilled(Vec2{ Pos.x + 8, Pos.y - 1 }, Vec2{ 17, 3 }, Color & IM_COL32_A_MASK);
		Gui.RectangleFilled(Vec2{ Pos.x + 7, Pos.y }, Vec2{ 17, 3 }, Color);
	}
